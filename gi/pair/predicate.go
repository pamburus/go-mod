...
func Less[V1, V2 constraints.Ordered](v1 V1, v2 V2) func(V1, V2) bool {
	return func(o1 V1, o2 V2) bool {
		switch {
		case v1 != o1:
			return v1 < o1
...
// Values are compared in the order they are given.
func LessOrEqual[V1, V2 constraints.Ordered](v1 V1, v2 V2) func(V1, V2) bool {
	return func(o1 V1, o2 V2) bool {
		switch {
		case v1 != o1:
			return v1 <= o1
...
// Values are compared in the order they are given.
func Greater[V1, V2 constraints.Ordered](v1 V1, v2 V2) func(V1, V2) bool {
	return Not(LessOrEqual(v1, v2))
}
...
// Values are compared in the order they are given.
func GreaterOrEqual[V1, V2 constraints.Ordered](v1 V1, v2 V2) func(V1, V2) bool {
