...
// MaxByLessFunc returns maximum value of the given values or [optval.None] if values is empty.
...
// MaxByCompareFunc returns maximum value of the given values or [optval.None] if values is empty.
