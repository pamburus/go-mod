...
// MapPairs returns an iterator adapter over pairs that uses a transform function to transform pairs.
func MapPairs[V1, V2, R1, R2 any, F ~func(V1, V2) (R1, R2)](pairs iter.Seq2[V1, V2], transform F) iter.Seq2[R1, R2] {
