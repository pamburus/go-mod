...
func Max[V1, V2 constraints.Ordered](values iter.Seq2[V1, V2]) optpair.Pair[V1, V2] {
	return Reduce(values, giop2.Max[V1, V2])
}
...
func MaxBy[V1, V2 any, K constraints.Ordered, F ~func(V1, V2) K](pairs iter.Seq2[V1, V2], key F) optpair.Pair[V1, V2] {
