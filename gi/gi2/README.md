# gi2 [![GoDoc][doc-img]][doc] [![Build Status][ci-img]][ci] [![Coverage Status][cov-img]][cov]

Package gi2 provides a set of helpers for working with generic iterators over pair of values.
